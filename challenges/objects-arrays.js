...
const animalNames = [];
zooAnimals
.forEach(animal =>  animalNames.push(`Name: ${animal.animal_name} Scientific: ${animal.scientific_name}`))
...
const lowerCase = zooAnimals
.map(animal => animal.animal_name.toLowerCase())
...
*/
const populationTotal = zooAnimals.reduce((index,animal) => animal.population +index,0);;
